...
TEST_CASE("DUNE ini file for ABtoC model", "[dune][ini]") {
  ...
  REQUIRE(*line++ == "d(A)/d(A) = -0.1*B");
  REQUIRE(*line++ == "d(A)/d(B) = -0.1*A");
  REQUIRE(*line++ == "d(A)/d(C) = 0");
  REQUIRE(*line++ == "d(B)/d(A) = -0.1*B");
  REQUIRE(*line++ == "d(B)/d(B) = -0.1*A");
  REQUIRE(*line++ == "d(B)/d(C) = 0");
  REQUIRE(*line++ == "d(C)/d(A) = 0.1*B");
  REQUIRE(*line++ == "d(C)/d(B) = 0.1*A");
  REQUIRE(*line++ == "d(C)/d(C) = 0");
  REQUIRE(*line++ == "");
