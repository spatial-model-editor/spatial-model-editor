...
TEST_CASE("XML Annotations",
  ...
  SECTION("Settings annotations") {
    ...
    simulationSettings.options.pixel.backend = simulate::PixelBackendType::GPU;
    ...
    meshParameters.maxCellVolumes = {11, 13, 17};
    ...
    REQUIRE(newMeshParameters.maxCellVolumes == meshParameters.maxCellVolumes);
  ...
  SECTION("Invalid settings annotations") {
    ...
    REQUIRE(settings.meshParameters.maxCellVolumes.empty());
