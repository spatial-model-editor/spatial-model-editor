...
export CIBW_ENVIRONMENT='CMAKE_ARGS="-DSME_BUILD_CORE=OFF -DCMAKE_PREFIX_PATH=/opt/smelibs;/opt/smelibs/lib64/cmake -DCUDAToolkit_ROOT=/opt/smelibs/cuda" CCACHE_DIR=/host/home/runner/.cache/ccache'
