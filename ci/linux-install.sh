...
# (note pinning to 4.3 as more recent versions depend on libhiredis >= 1)
CCACHE_FILE="ccache-4.3-haef5404_1.tar.bz2"
wget https://anaconda.org/conda-forge/ccache/4.3/download/linux-64/${CCACHE_FILE}
tar -xf ${CCACHE_FILE}
