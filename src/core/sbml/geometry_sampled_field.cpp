...
importGeometryFromSampledField(const libsbml::Geometry *geom) {
  ...
  gsf.sampledFieldGeometry =
      const_cast<libsbml::SampledFieldGeometry *>(sfgeom);
