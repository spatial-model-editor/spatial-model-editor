...
static triangle::triangulateio toTriangulateio(
...
const char* triangleFlags = "Qzpq20.5Aa";

static TriangulateBoundaries addSteinerPoints(
    const TriangulateBoundaries& tid) {
...
TriangulateBoundaries Triangulate::addMembranes(
    const TriangulateBoundaries& tid, const TriangulateFixedPoints& tfp) {
...
static std::vector<QPointF> getPointsFromTriangulateio(
    const triangle::triangulateio& io) {
