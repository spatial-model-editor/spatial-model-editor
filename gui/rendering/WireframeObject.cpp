...
rendering::WireframeObject::WireframeObject(const WireframeObject& cpy)
{
  QOpenGLFunctions::initializeOpenGLFunctions();
...
void rendering::WireframeObject::Render(rendering::ShaderProgram* program, float lineWidth)
{
...
void rendering::WireframeObject::SetRotation(GLfloat rotationX, GLfloat rotationY, GLfloat rotationZ)
{
...
void rendering::WireframeObject::SetPosition(GLfloat positionX, GLfloat positionY, GLfloat positionZ)
{
...
void rendering::WireframeObject::SetScale(GLfloat scaleX, GLfloat scaleY, GLfloat scaleZ)
{
  m_scale.x = scaleX;
  m_scale.y = scaleY;
  m_scale.z = scaleZ;
...
rendering::Vector3 rendering::WireframeObject::GetScale()
{
  return m_scale;
}