...
QVector3D
rendering::Utils::rotationMatrixToEulerAngles(const QMatrix4x4 &rotation) {

  QQuaternion quaternion = QQuaternion::fromAxes(
      rotation.column(0).toVector3D(), rotation.column(1).toVector3D(),
      rotation.column(2).toVector3D());
